...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 100  -- 2D轨迹构建器中子地图的范围数据数量
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.05)  -- 1.0改成0.1,提高对运动的敏感度
POSE_GRAPH.constraint_builder.min_score = 0.55                          -- Fast csm的最低分数，高于此分数才进行优化。
