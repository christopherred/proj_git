...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        Node(
            package='rtabmap_start',
            executable='rgbd_converter',
            name='rgbd_converter',
            output='screen'
        ),
        ...
        Node(
            ...
            remappings=[
                ...
                # ("depth/image", LaunchConfiguration('depth_topic_relay')),
                # ("rgb/camera_info", LaunchConfiguration('camera_info_topic')),
                ("rgbd_image", '/camera/camera/rgbd_converted'),
                ("odom", '/rtabmap/odom'),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('queue_size',     default_value='60',    description='Backward compatibility, use "sync_queue_size" instead.'),
        ...
        DeclareLaunchArgument('wait_for_transform', default_value='1.0',            description=''),
        DeclareLaunchArgument('rtabmap_args',   default_value='args',                   description='Backward compatibility, use "args" instead.'),
        ...
        DeclareLaunchArgument('approx_sync_max_interval',  default_value='2.0', description='(sec) 0 means infinite interval duration (used with approx_sync=true)'),
        ...
        DeclareLaunchArgument('subscribe_rgbd',   default_value='true', description='Already synchronized RGB-D related topic, e.g., with rtabmap_sync/rgbd_sync nodelet.'),
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/sensors/ladar/scan',       description=''),
        ...
        DeclareLaunchArgument('scan_normal_k',        default_value='16',           description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/rtabmap/odom',  description='Odometry topic name.'),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/sensors/imu/imu', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
        ...
        #GPS
        DeclareLaunchArgument('gps_topic',  default_value='/sensors/gps/fix', description='GPS async subscription. This is used for SLAM graph optimization and loop closure candidates selection.'),
