...
ros2 launch rtabmap_launch rtabmap.launch.py \
    ...
    rtabmap_args:="--Vis/MinInliers 12 \
        ...
        --Odom/ScanVoxelSize 0.02 \
        --Odom/ScanMaxSize 30000 \
        --Odom/ScanNormalK 15 \
        --Odom/ScanNormalRadius 0.05 \
        --Odom/ScanLocalMap true \
        --Odom/ScanLocalMapDecimation 2 \
        --Odom/ScanMaxRange 12.0 \
        --Odom/ScanMinRange 0.2 \
        --Odom/ScanMinInliers 100 \
        --Odom/ScanIterations 50 \
        --Odom/ScanMaxTranslation 0.5 \
        --Odom/ScanMaxRotation 0.78 \
        --Odom/ScanSubtractRadius 0.1 \
        --Odom/ScanSubtractAngle 0.5 \
