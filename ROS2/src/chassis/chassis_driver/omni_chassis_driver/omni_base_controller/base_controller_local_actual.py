...
class Omni3WheelRobotKinematics(object):
    ...
    def forward(self, dpm1, dpm2, dpm3):
        ...
        # Args:
        #     dpm1 (float): 轮子 1 的转速 (rad/s)
        #     dpm2 (float): 轮子 2 的转速 (rad/s)
        #     dpm3 (float): 轮子 3 的转速 (rad/s)
        ...
        # 得到速度向量
        velocity_vector = convert_matrix_inverse @ dphi
    ...
    def inverse(self, linear_x, linear_y, angular_z):
        ...
        # Returns:
        #     (dpm1, dpm2, dpm3): 三个轮子的转速 (rad/s)【注意，不用管dpm，单位是rad/s！！！】
        # """
        ...
        dphi = (1/self.wheel_radius)*convert_matrix@np.array([[vx_new],[vy_new],[angular_z]])
